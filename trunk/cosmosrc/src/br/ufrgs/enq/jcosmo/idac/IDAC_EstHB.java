...
public class IDAC_EstHB implements CostFunction, ObjectiveFunction {

	List<IDACExperiments> experiments;

	public IDAC_EstHB() throws Exception {
...
//		experiments.add(new IDACExperiments("idac/Alcohol-Water.csv", modelClass));
		experiments.add(new IDACExperiments("idac/Alcohol-Water298.csv", modelClass));
...
//		experiments.add(new IDACExperiments("idac/Water.csv", modelClass));
		experiments.add(new IDACExperiments("idac/Water298.csv", modelClass));
//
...
//				cosmo.setVnorm(pars[i++]);
			...
			// check if the number is greater than zero and is not a NaN
