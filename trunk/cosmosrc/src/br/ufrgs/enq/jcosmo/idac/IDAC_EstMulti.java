...
//		experiments.add(new IDACExperimentsMulti("idac/AlcoholSmall-Water298.csv", modelClass));
...
//		pars[i++] = cosmo.getCHB(4,2);
//		pars[i++] = cosmo.getCHB(4,3);
...
//				cosmo.setCHB(4,2, pars[i++]);
//				cosmo.setCHB(4,3, pars[i++]);
