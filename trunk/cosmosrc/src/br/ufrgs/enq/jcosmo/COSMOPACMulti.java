...
//		setAEff(7.5);
		...
		setSigmaHB(0.004071962241202693);
		setSigmaHB2(0);
		setCHB(1, 2, 242);
		setCHB(2, 1, 0);
		setCHB(1, 3, 10607.);
...
//		// EPS=999.0 CHARGE=0 COSWRT RSOLV=1.2 RM1 VDW(:H=1.3:C=2.0:N=1.83:O=1.72:F=1.72:S=2.16:P=2.12:Cl=2.35:Br=2.16:I=2.32) GNORM=0.1 RELSCF=0.1
//		// idac/nonHB.csv AARD:0.108 NP:74
//		setBeta(2.1428668591099327);
//		setFpol(0.3345272065225727);
//		setFpol(1, 0.5371589768218414);
//		setFpol(2, 0.4341647271054313);
//		setFpol(3, 0.3329824876975987);
//		setIgnoreSG(false);
//		setCoord(10.0);
//		setAnorm(18.53474952049008);
//		setVnorm(66.69);
//		
//		setCHB(1, 2, 800);
//		setCHB(2, 1, 800);
